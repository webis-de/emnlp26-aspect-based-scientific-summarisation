...
if __name__ == "__main__":
	...
	evidence_guided = [
			"We fine-tune a BART-large model using 50k PubMed abstracts. Training is performed for 3 epochs with a learning rate of 3e-5.",
			"We discard samples with confidence below 0.7.",
	]
